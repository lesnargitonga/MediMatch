...
const FACILITIES: Facility[] = [
  ...
  // ---- Nairobi County, full network: private referral hubs + sub-county health centres ----
  { id: 47, name: 'Mater Misericordiae Hospital',              contact: 'South B Coordinator',            county: 'Nairobi',     lat: -1.3060, lon: 36.8330, verified: true,  rating: 4.6, ratings: 24, hub: true  },
  { id: 48, name: 'Avenue Healthcare Parklands',               contact: 'Parklands Coordinator',          county: 'Nairobi',     lat: -1.2610, lon: 36.8120, verified: true,  rating: 4.4, ratings: 18, hub: true  },
  { id: 49, name: 'Westlands Health Centre',                   contact: 'Westlands Coordinator',          county: 'Nairobi',     lat: -1.2680, lon: 36.8050, verified: false, rating: 3.8, ratings: 5,  hub: false },
  { id: 50, name: 'Kangemi Health Centre',                     contact: 'Westlands Coordinator',          county: 'Nairobi',     lat: -1.2660, lon: 36.7430, verified: false, rating: 3.7, ratings: 4,  hub: false },
  { id: 51, name: 'Dagoretti Sub-County Hospital',             contact: 'Dagoretti Coordinator',          county: 'Nairobi',     lat: -1.2880, lon: 36.7470, verified: true,  rating: 4.0, ratings: 8,  hub: false },
  { id: 52, name: 'Langata Health Centre',                     contact: 'Langata Coordinator',            county: 'Nairobi',     lat: -1.3370, lon: 36.7440, verified: false, rating: 3.8, ratings: 5,  hub: false },
  { id: 53, name: 'Kibra Health Centre',                       contact: 'Kibra Coordinator',              county: 'Nairobi',     lat: -1.3120, lon: 36.7820, verified: false, rating: 3.6, ratings: 4,  hub: false },
  { id: 54, name: 'Makadara Health Centre',                    contact: 'Makadara Coordinator',           county: 'Nairobi',     lat: -1.2970, lon: 36.8650, verified: false, rating: 3.7, ratings: 5,  hub: false },
  { id: 55, name: 'Kaloleni Health Centre',                    contact: 'Makadara Coordinator',           county: 'Nairobi',     lat: -1.2890, lon: 36.8590, verified: false, rating: 3.6, ratings: 3,  hub: false },
  { id: 56, name: 'Jericho Health Centre',                     contact: 'Makadara Coordinator',           county: 'Nairobi',     lat: -1.2920, lon: 36.8700, verified: false, rating: 3.7, ratings: 4,  hub: false },
  { id: 57, name: 'Kariobangi Health Centre',                  contact: 'Embakasi Coordinator',           county: 'Nairobi',     lat: -1.2570, lon: 36.8800, verified: false, rating: 3.6, ratings: 4,  hub: false },
  { id: 58, name: 'Korogocho Health Centre',                   contact: 'Ruaraka Coordinator',            county: 'Nairobi',     lat: -1.2480, lon: 36.8830, verified: false, rating: 3.5, ratings: 3,  hub: false },
  { id: 59, name: 'Baba Dogo Health Centre',                   contact: 'Ruaraka Coordinator',            county: 'Nairobi',     lat: -1.2440, lon: 36.8770, verified: false, rating: 3.6, ratings: 4,  hub: false },
  { id: 60, name: 'Githurai Health Centre',                    contact: 'Roysambu Coordinator',           county: 'Nairobi',     lat: -1.1960, lon: 36.9230, verified: false, rating: 3.7, ratings: 5,  hub: false },
  { id: 61, name: 'Kahawa West Health Centre',                 contact: 'Roysambu Coordinator',           county: 'Nairobi',     lat: -1.1900, lon: 36.9180, verified: false, rating: 3.6, ratings: 4,  hub: false },
  { id: 62, name: 'Roysambu Health Centre',                    contact: 'Roysambu Coordinator',           county: 'Nairobi',     lat: -1.2170, lon: 36.8930, verified: false, rating: 3.7, ratings: 4,  hub: false },
  { id: 63, name: 'Kasarani Health Centre',                    contact: 'Kasarani Coordinator',           county: 'Nairobi',     lat: -1.2200, lon: 36.8960, verified: true,  rating: 3.9, ratings: 7,  hub: false },
  { id: 64, name: 'Mwiki Health Centre',                       contact: 'Kasarani Coordinator',           county: 'Nairobi',     lat: -1.2200, lon: 36.9420, verified: false, rating: 3.6, ratings: 3,  hub: false },
  { id: 65, name: 'Njiru Health Centre',                       contact: 'Embakasi Coordinator',           county: 'Nairobi',     lat: -1.2480, lon: 36.9560, verified: false, rating: 3.5, ratings: 3,  hub: false },
  { id: 66, name: 'Komarock Health Centre',                    contact: 'Embakasi Coordinator',           county: 'Nairobi',     lat: -1.2730, lon: 36.9080, verified: false, rating: 3.7, ratings: 5,  hub: false },
  { id: 67, name: 'Umoja Health Centre',                       contact: 'Embakasi Coordinator',           county: 'Nairobi',     lat: -1.2820, lon: 36.8930, verified: false, rating: 3.7, ratings: 4,  hub: false },
  { id: 68, name: 'Mukuru kwa Njenga Health Centre',           contact: 'Embakasi Coordinator',           county: 'Nairobi',     lat: -1.3170, lon: 36.8870, verified: false, rating: 3.5, ratings: 3,  hub: false },
  { id: 69, name: 'Mukuru kwa Reuben Health Centre',           contact: 'Makadara Coordinator',           county: 'Nairobi',     lat: -1.3080, lon: 36.8730, verified: false, rating: 3.5, ratings: 3,  hub: false },
  { id: 70, name: 'Lunga Lunga Health Centre',                 contact: 'Makadara Coordinator',           county: 'Nairobi',     lat: -1.3020, lon: 36.8650, verified: false, rating: 3.6, ratings: 4,  hub: false },
  { id: 71, name: 'Sinai Health Centre',                       contact: 'Makadara Coordinator',           county: 'Nairobi',     lat: -1.3050, lon: 36.8590, verified: false, rating: 3.5, ratings: 3,  hub: false },
  { id: 72, name: 'Eastleigh Health Centre',                   contact: 'Kamukunji Coordinator',          county: 'Nairobi',     lat: -1.2730, lon: 36.8480, verified: false, rating: 3.7, ratings: 5,  hub: false },
];
...
const SEEDS: Seed[] = [
  ...
  // ===== Nairobi full network: more hub surplus =====
  { owner: 'Mater Misericordiae Hospital',               title: 'Oxygen concentrators (10L)',        item: 'oxygen_concentrator', description: 'Surplus after ward refurbishment.',                                 quantity: 12,  category: 'equipment',  is_urgent: false, kind: 'offer',   ageMin: 200 },
  { owner: 'Mater Misericordiae Hospital',               title: "IV fluids (Ringer's lactate)",      item: 'iv_fluids',           description: 'Bulk surplus, 500ml bags.',                                          quantity: 700, category: 'supplies',   is_urgent: false, kind: 'offer',   ageMin: 230 },
  { owner: 'Mater Misericordiae Hospital',               title: 'Surgical kits (sterile)',           item: 'surgical_kit',        description: 'Sealed disposable kits.',                                            quantity: 200, category: 'supplies',   is_urgent: false, kind: 'offer',   ageMin: 180 },
  { owner: 'Mater Misericordiae Hospital',               title: 'Antimalarials (AL)',                item: 'antimalarial',        description: 'Surplus seasonal allocation.',                                       quantity: 350, category: 'medication', is_urgent: false, kind: 'offer',   ageMin: 260 },
  { owner: 'Avenue Healthcare Parklands',                title: 'Insulin (refrigerated)',            item: 'insulin',             description: 'Cold-chain vials, long-dated.',                                      quantity: 160, category: 'medication', is_urgent: false, kind: 'offer',   ageMin: 240 },
  { owner: 'Avenue Healthcare Parklands',                title: 'Amoxicillin 500mg',                 item: 'amoxicillin',         description: '120-cap bottles, expiry 2027.',                                      quantity: 320, category: 'medication', is_urgent: false, kind: 'offer',   ageMin: 300 },
  { owner: 'Avenue Healthcare Parklands',                title: 'Surgical masks (boxes of 50)',      item: 'surgical_masks',      description: 'Sealed, unused stock.',                                              quantity: 220, category: 'supplies',   is_urgent: false, kind: 'offer',   ageMin: 280 },

  // ===== Nairobi full network: sub-county health-centre needs =====
  { owner: 'Westlands Health Centre',                    title: 'IV fluids needed',                  item: 'iv_fluids',           description: 'Outpatient rehydration top-up.',                                     quantity: 90,  category: 'supplies',   is_urgent: false, kind: 'request', ageMin: 120 },
  { owner: 'Kangemi Health Centre',                      title: 'Amoxicillin urgently needed',       item: 'amoxicillin',         description: 'Paediatric respiratory surge.',                                      quantity: 110, category: 'medication', is_urgent: true,  kind: 'request', ageMin: 38  },
  { owner: 'Dagoretti Sub-County Hospital',              title: 'Oxygen concentrators needed',       item: 'oxygen_concentrator', description: 'Ward units offline.',                                                quantity: 3,   category: 'equipment',  is_urgent: true,  kind: 'request', ageMin: 50  },
  { owner: 'Langata Health Centre',                      title: 'Insulin needed',                    item: 'insulin',             description: 'Diabetes clinic top-up.',                                            quantity: 18,  category: 'medication', is_urgent: false, kind: 'request', ageMin: 130 },
  { owner: 'Kibra Health Centre',                        title: 'IV fluids urgently needed',         item: 'iv_fluids',           description: 'Diarrhoeal outbreak in catchment.',                                  quantity: 120, category: 'supplies',   is_urgent: true,  kind: 'request', ageMin: 30  },
  { owner: 'Makadara Health Centre',                     title: 'Surgical masks needed',             item: 'surgical_masks',      description: 'Outpatient demand.',                                                 quantity: 90,  category: 'supplies',   is_urgent: false, kind: 'request', ageMin: 150 },
  { owner: 'Kaloleni Health Centre',                     title: 'Amoxicillin needed',                item: 'amoxicillin',         description: 'Routine paediatric stock.',                                          quantity: 90,  category: 'medication', is_urgent: false, kind: 'request', ageMin: 160 },
  { owner: 'Jericho Health Centre',                      title: 'Antimalarials needed',              item: 'antimalarial',        description: 'Malaria uptick.',                                                    quantity: 130, category: 'medication', is_urgent: false, kind: 'request', ageMin: 140 },
  { owner: 'Kariobangi Health Centre',                   title: 'Oxygen concentrators needed',       item: 'oxygen_concentrator', description: 'Informal-settlement respiratory load.',                              quantity: 3,   category: 'equipment',  is_urgent: true,  kind: 'request', ageMin: 44  },
  { owner: 'Korogocho Health Centre',                    title: 'IV fluids urgently needed',         item: 'iv_fluids',           description: 'Cholera response.',                                                  quantity: 110, category: 'supplies',   is_urgent: true,  kind: 'request', ageMin: 26  },
  { owner: 'Baba Dogo Health Centre',                    title: 'Amoxicillin needed',                item: 'amoxicillin',         description: 'Paediatric respiratory infections.',                                quantity: 100, category: 'medication', is_urgent: false, kind: 'request', ageMin: 155 },
  { owner: 'Githurai Health Centre',                     title: 'Antimalarials needed',              item: 'antimalarial',        description: 'Post-rains malaria.',                                                quantity: 140, category: 'medication', is_urgent: false, kind: 'request', ageMin: 135 },
  { owner: 'Kahawa West Health Centre',                  title: 'Insulin needed',                    item: 'insulin',             description: 'Diabetes outpatient clinic.',                                        quantity: 16,  category: 'medication', is_urgent: false, kind: 'request', ageMin: 145 },
  { owner: 'Roysambu Health Centre',                     title: 'Surgical masks needed',             item: 'surgical_masks',      description: 'Outpatient cover.',                                                  quantity: 80,  category: 'supplies',   is_urgent: false, kind: 'request', ageMin: 165 },
  { owner: 'Kasarani Health Centre',                     title: 'Oxygen concentrators needed',       item: 'oxygen_concentrator', description: 'Maternity respiratory cover.',                                       quantity: 4,   category: 'equipment',  is_urgent: true,  kind: 'request', ageMin: 56  },
  { owner: 'Mwiki Health Centre',                        title: 'IV fluids needed',                  item: 'iv_fluids',           description: 'Casualty top-up.',                                                   quantity: 90,  category: 'supplies',   is_urgent: false, kind: 'request', ageMin: 170 },
  { owner: 'Njiru Health Centre',                        title: 'Amoxicillin needed',                item: 'amoxicillin',         description: 'Routine paediatric stock.',                                          quantity: 90,  category: 'medication', is_urgent: false, kind: 'request', ageMin: 175 },
  { owner: 'Komarock Health Centre',                     title: 'Oxygen concentrators needed',       item: 'oxygen_concentrator', description: 'Ward unit down.',                                                    quantity: 2,   category: 'equipment',  is_urgent: false, kind: 'request', ageMin: 160 },
  { owner: 'Umoja Health Centre',                        title: 'Insulin urgently needed',           item: 'insulin',             description: 'Diabetic emergencies — cold-chain depleted.',                        quantity: 22,  category: 'medication', is_urgent: true,  kind: 'request', ageMin: 40  },
  { owner: 'Mukuru kwa Njenga Health Centre',            title: 'IV fluids urgently needed',         item: 'iv_fluids',           description: 'Outbreak response in settlement.',                                   quantity: 120, category: 'supplies',   is_urgent: true,  kind: 'request', ageMin: 28  },
  { owner: 'Mukuru kwa Reuben Health Centre',            title: 'Surgical kits needed',              item: 'surgical_kit',        description: 'Minor-theatre running low.',                                         quantity: 50,  category: 'supplies',   is_urgent: false, kind: 'request', ageMin: 150 },
  { owner: 'Lunga Lunga Health Centre',                  title: 'Antimalarials needed',              item: 'antimalarial',        description: 'Malaria caseload.',                                                  quantity: 120, category: 'medication', is_urgent: false, kind: 'request', ageMin: 158 },
  { owner: 'Sinai Health Centre',                        title: 'Amoxicillin urgently needed',       item: 'amoxicillin',         description: 'Respiratory infection cluster.',                                     quantity: 100, category: 'medication', is_urgent: true,  kind: 'request', ageMin: 42  },
  { owner: 'Eastleigh Health Centre',                    title: 'Insulin needed',                    item: 'insulin',             description: 'Diabetes clinic top-up.',                                            quantity: 18,  category: 'medication', is_urgent: false, kind: 'request', ageMin: 148 },
];
